...
<html doctype>
	...
	<body>
		...
		<ul>
			...
			<li>On 14 December 2016 and 13 December 2017, I have given guest lectures for Software Evolution, a course I used to give.</li>
			<li>In November 2017, I will come to the Thesis Fair again.</li>
		</ul>
		...
		<ul>
			...
			<li class="title">Project Software Engineering (BSc level)
				<ul>
					...
					my role: coordinator; people involved: Machiel van der Bijl and external auditors <a href="http://grammarware.net/writes/index.html#Flipped2015" class="red">(paper)</a></li>
				</ul>
			</li>
